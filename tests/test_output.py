...
def template(request: pytest.FixtureRequest) -> Iterator[Path | str]:
...
@pulumi.runtime.test
def test_render_template_inputs(template: Path | str) -> Any:
...
def test_render_template_inputs_and_context_mutually_exclusive() -> None:
    """Render template with Pulumi inputs."""
    # Arrange
    # ...
